...
function [V0, c1, c2] = Heston_EuUpOutCall_MC_Euler(S0, r, gamma0, kappa, lambda, sigma_tilde, T, g, M, m, B, K)
...
[V0, c1, c2] = Heston_EuUpOutCall_MC_Euler(S0, r, gamma0, kappa, lambda, sigma_tilde, T, g, M, m, B, K)
disp("Price of the Eu up-and-out Call in the Heston model is: " + string(V0))
